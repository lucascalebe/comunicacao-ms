...
`docker run --name sales-db -d -p 27017:27017 -p 28017:28017 -e MONGO_INITDB_ROOT_USERNAME="admin" -e MONGO_INITDB_ROOT_PASSWORD="123456" mongo`

#### Conexão no Mongosh

`docker exec -it sales-db mongosh -u admin -p 123456`
